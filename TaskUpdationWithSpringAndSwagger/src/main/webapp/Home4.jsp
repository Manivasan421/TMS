...
<div class="top">
<ul>
  <li><a href="ProjectDetail.jsp" target="iframe_a">Create Project</a></li>
  <li><a href="AssignProject.jsp" target="iframe_a">Assign Project</a></li>
  <li><a href="#" target="iframe_a">Summary</a></li>
  <li><a href="#" target="iframe_a">DashBoard</a></li>
  <li><div id="box3">Welcome&nbsp<%=session.getAttribute("name") %></div></li>
