...
<div id="header-left-icon"><a href="dashboard.html"><i class="fa fa-angle-left"></i></a></div>
<div id="header-left-text"><a href="#/">Drag and Drop Template</a></div>
</div>

<!-- <div id="header-right">
<div id="header-right-icon"><a href="http://simbyone.com/download/drag-and-drop-newsletter-builder-using-jquery/"><i class="fa fa-cloud-download"></i></a></div>
<div id="header-right-text"><a href="http://simbyone.com/download/drag-and-drop-newsletter-builder-using-jquery/">Download Source</a></div>
</div> -->
</div>
...
<div id="sample"></div>
<form id="export-form" method="post" action="export.php" name="export-form">
...
<div id="newsletter-preloaded-rows">
      ...
      <div class="sim-row-header1-nav-logo sim-row-edit" data-type="image"><img src="http://1.bp.blogspot.com/-VRSy3Q4RutU/VekuaZeFY5I/AAAAAAAABjw/SvXZFgONlcg/s1600/kumaran%2BSystems.png"/></div>
      ...
      <div class="sim-row-header1-slider-right sim-row-edit" data-type="image"><img src="http://simbyone.com/demo/drag-and-drop-newsletter-builder-using-jquery/_assets/ipad.png" /></div>
      </div>
      </div>
      </div>
      ...
      <div class="sim-row-header2-nav-logo sim-row-edit" data-type="image"><img src="http://1.bp.blogspot.com/-VRSy3Q4RutU/VekuaZeFY5I/AAAAAAAABjw/SvXZFgONlcg/s1600/kumaran%2BSystems.png"/></div>
      ...
      <div class="sim-row-header2-slider-bottom sim-row-edit" data-type="image"><img src="http://1.bp.blogspot.com/-VRSy3Q4RutU/VekuaZeFY5I/AAAAAAAABjw/SvXZFgONlcg/s1600/kumaran%2BSystems.png"/></div>
      </div>
      </div>
      </div>
      ...
      <div class="sim-row-content1-tab-text sim-row-edit" data-type="text">Ut iaculis ut massa sit amet dictum. Nulla tortor metus, eleifend vel</div>
       ...
       <div class="sim-row-content2-left sim-row-edit" data-type="image"><img src="http://simbyone.com/demo/drag-and-drop-newsletter-builder-using-jquery/_assets/ipad.png" /></div>
      ...
      <div class="sim-row-content3-center-tab-image sim-row-edit" data-type="image"><img src="http://simbyone.com/demo/drag-and-drop-newsletter-builder-using-jquery/_assets/ipad.png"></div>
      ...
      <div class="sim-row-content4-images sim-row-edit" data-type="image"><img src="http://1.bp.blogspot.com/-VRSy3Q4RutU/VekuaZeFY5I/AAAAAAAABjw/SvXZFgONlcg/s1600/kumaran%2BSystems.png" /></div>
      </div>
      </div>
      ...
      <div class="sim-row-content5">
       ...
       <div class="sim-row-content5-right sim-row-edit" data-type="image"><img src="http://simbyone.com/demo/drag-and-drop-newsletter-builder-using-jquery/_assets/ipad.png" /></div>
       </div>
       </div>
      ...
      <div class="sim-row-content7">
       ...
       <div class="sim-row-content7-center-tab-image sim-row-edit" data-type="image"><img src="http://simbyone.com/demo/drag-and-drop-newsletter-builder-using-jquery/_assets/ipad.png" /></div>
     ...
     <div class="sim-row" data-id="11">
      <div class="sim-row-content8">
       ...
       <div class="sim-row-content8-center-tab-image sim-row-edit" data-type="image"><img src="http://simbyone.com/demo/drag-and-drop-newsletter-builder-using-jquery/_assets/ipad.png" /></div>
      ...
      <div class="sim-row-content9-images sim-row-edit" data-type="image"><img src="http://1.bp.blogspot.com/-VRSy3Q4RutU/VekuaZeFY5I/AAAAAAAABjw/SvXZFgONlcg/s1600/kumaran%2BSystems.png" /></div>
      </div>
      </div>
       ...
       <div class="sim-row-content10-center-tab-image sim-row-edit" data-type="image"><img src="http://simbyone.com/demo/drag-and-drop-newsletter-builder-using-jquery/_assets/ipad.png" /></div>
       ...
       <div class="sim-row-content11-center-tab-image sim-row-edit" data-type="image"><img src="http://simbyone.com/demo/drag-and-drop-newsletter-builder-using-jquery/_assets/ipad.png" /></div>
       ...
       <div class="sim-row-content13-center-left-subtitle sim-row-edit" data-type="title">Lets start something big</div>
       </div>
      ...
      <div class="sim-row-content15-center-left sim-row-edit" data-type="image"><img src="http://simbyone.com/demo/drag-and-drop-newsletter-builder-using-jquery/_assets/newsletter_logo_white.png"/></div>
...
<div id="newsletter-builder" class="resize-height">
  ...
  <div id="newsletter-builder-sidebar">
    <div id="newsletter-builder-sidebar-logo"><img src="https://jobs.felight.com/wp-content/uploads/2016/08/kumar-system-logo.png" width="150" height="150" /></div>
    <div id="newsletter-builder-sidebar-buttons">
      <div id="newsletter-builder-sidebar-buttons-abutton">Save Template</div>
       <div id="newsletter-builder-sidebar-buttons-vbutton" >Create</div>
  ...
  <div id="newsletter-builder-area" class="resize-height resize-width">
    <div id="newsletter-builder-area-center">
      ...
      <div class="newsletter-builder-area-center-frame-buttons-dropdown-tab" id="add-header"><p>Select Templete </p><i class="fa fa-caret-right"></i></div>
      ...
      <div class="newsletter-builder-area-center-frame-buttons-content-tab" data-type="header" data-id="1"><img src="_row_thumbs/sim-row-thumb_1.png" /></div>
      <div class="newsletter-builder-area-center-frame-buttons-content-tab" data-type="header" data-id="2"><img src="_row_thumbs/sim-row-thumb_2.png" /></div>
      <div class="newsletter-builder-area-center-frame-buttons-content-tab" data-type="header" data-id="3"><img src="_row_thumbs/sim-row-thumb_3.png" /></div>
      <div class="newsletter-builder-area-center-frame-buttons-content-tab" data-type="content" data-id="4"><img src="_row_thumbs/sim-row-thumb_4.png" /></div>
      <div class="newsletter-builder-area-center-frame-buttons-content-tab" data-type="content" data-id="5"><img src="_row_thumbs/sim-row-thumb_5.png" /></div>
      <div class="newsletter-builder-area-center-frame-buttons-content-tab" data-type="content" data-id="6"><img src="_row_thumbs/sim-row-thumb_6.png" /></div>
      <div class="newsletter-builder-area-center-frame-buttons-content-tab" data-type="content" data-id="7"><img src="_row_thumbs/sim-row-thumb_7.png" /></div>
      <div class="newsletter-builder-area-center-frame-buttons-content-tab" data-type="content" data-id="8"><img src="_row_thumbs/sim-row-thumb_8.png" /></div>
      <div class="newsletter-builder-area-center-frame-buttons-content-tab" data-type="content" data-id="9"><img src="_row_thumbs/sim-row-thumb_9.png" /></div>
      <div class="newsletter-builder-area-center-frame-buttons-content-tab" data-type="content" data-id="10"><img src="_row_thumbs/sim-row-thumb_10.png" /></div>
      <div class="newsletter-builder-area-center-frame-buttons-content-tab" data-type="content" data-id="11"><img src="_row_thumbs/sim-row-thumb_11.png" /></div>
      <div class="newsletter-builder-area-center-frame-buttons-content-tab" data-type="content" data-id="12"><img src="_row_thumbs/sim-row-thumb_12.png" /></div>
      <div class="newsletter-builder-area-center-frame-buttons-content-tab" data-type="content" data-id="13"><img src="_row_thumbs/sim-row-thumb_13.png" /></div>
      <div class="newsletter-builder-area-center-frame-buttons-content-tab" data-type="content" data-id="14"><img src="_row_thumbs/sim-row-thumb_14.png" /></div>
      <div class="newsletter-builder-area-center-frame-buttons-content-tab" data-type="content" data-id="15"><img src="_row_thumbs/sim-row-thumb_15.png" /></div>
      <div class="newsletter-builder-area-center-frame-buttons-content-tab" data-type="footer" data-id="16"><img src="_row_thumbs/sim-row-thumb_16.png" /></div>
      <div class="newsletter-builder-area-center-frame-buttons-content-tab" data-type="footer" data-id="17"><img src="_row_thumbs/sim-row-thumb_17.png" /></div>
      <div class="newsletter-builder-area-center-frame-buttons-content-tab" data-type="footer" data-id="18"><img src="_row_thumbs/sim-row-thumb_18.png" /></div>

      </div>
      </div>
      
      </div>
      <div id="newsletter-builder-area-center-frame-buttons-reset"><a href="index.jsp"><i class="icon-reload-CCW"></i>&nbsp;&nbsp;Reset</a></div>
      </div>
  ...
  <button type="submit" class="btn" id="get" onclick="sendme()">Create Campaign!</button>
</div>
<div style="height:100px; width:100px" class="total-title" id="call">
    first text
</div>


<script>
$('#newsletter-builder-sidebar-buttons-vbutton').click(function(){
	var text = $('#call').text();
 var name=sessionStorage.getItem("campaignname");
	if(name != "" ){
		 sessionStorage.setItem("sl",text);
		 window.location="createcampaign.html";
	    }
