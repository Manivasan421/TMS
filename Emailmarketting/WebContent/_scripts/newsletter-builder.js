...
//Download
 $("#newsletter-builder-sidebar-buttons-abutton").click(function(){
	...
	$('#set').val(export_content);
	
	
	 alert("Your Templete successfully Saved...............Next Click Create Button")
	...
	export_content = '<style>'+data+'</style><link href="http://fonts.googleapis.com/css?family=Source+Sans+Pro:200,300,400,600,700,900,200italic,300italic,400italic,600italic,700italic,900italic" rel="stylesheet" type="text/css"><link rel="stylesheet" href="http://maxcdn.bootstrapcdn.com/font-awesome/4.3.0/css/font-awesome.min.css"><div id="sim-wrapper"><div id="sim-wrapper-newsletter">'+preload_export_html+'</div></div>'+export_content;
	 
	 $('div.total-title').html(export_content);
	 
	var textToSave = document.getElementById("sample").innerText;
 
    var hiddenElement = document.createElement('a');
  
 /*   
    hiddenElement.href = 'data:attachment/text,' + encodeURI(export_content);
